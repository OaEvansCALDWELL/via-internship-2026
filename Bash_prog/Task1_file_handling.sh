...
# @author      Evans Caldwell Owusu-Antwi
# @index       5230160083
# @school      University of Skilled Training and Entrepreneurial Development (USTED)
# @description Creates a directory and file, writes/appends/reads content,
#              backs it up, then deletes the original with confirmation.
# @date        2026-09-14
# ---------------------------------------------------
